...
admin_role = Role.create(name: 'admin', permission_attributes:
                        { can_lock_user: true, can_edit_role: true, can_edit_permission: true,
                          can_read_rating: true, can_give_rating: true,
                          can_set_role: true, can_edit_movie: true, can_read_movie: true,
                          can_edit_person: true, can_read_person: true,
...
redactor_role = Role.create(name: 'redactor', permission_attributes:
                        { can_lock_user: false, can_edit_role: false, can_edit_permission: false,
                          can_read_rating: true, can_give_rating: true,
                          can_set_role: false, can_edit_movie: true, can_read_movie: true,
                          can_edit_person: true, can_read_person: true,
                          can_read_entities: true, can_edit_entities: true, can_read_user: true })
reviewer_role = Role.create(name: 'reviewer', permission_attributes:
                        { can_lock_user: false, can_edit_role: false, can_edit_permission: false,
                          can_read_rating: true, can_give_rating: true,
                          can_set_role: false, can_edit_movie: false, can_read_movie: true,
                          can_edit_person: false, can_read_person: true,
