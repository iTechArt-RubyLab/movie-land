...
class User < ApplicationRecord
  ...
  delegate :can_read_entities?, :can_edit_entities?, :can_lock_user?, :can_edit_role?, :can_set_role?, :can_read_movie_and_person?, :can_edit_movie_and_person?, :admin?, :redactor?, :reviewer?, to: :role
